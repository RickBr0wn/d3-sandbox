...
// Create y 'dotted line' and append to the 'line' group
...
const handleMouseOver = (data, index, array) => {
  ...
  // Set the x 'dotted line' coord (x1, x2, y1, y2)
  xDottedLine
  ...
  // Set the 'dotted line' coord (x1, x2, y1, y2)
  yDottedLine
    .attr('x1', 0)
    .attr('x2', x(new Date(data.date)))
...
const handleClick = data => {
  ...
  database.collection('activities').doc(data.id).delete()
}